        ...
        <div class="container items-center max-w-6xl px-8 mx-auto xl:px-5">
            ...
            > -->
                        ...
                        <p class="mx-auto text-base text-gray-500 sm:max-w-md lg:text-xl md:max-w-3xl">
                            Restaurant kami adalah restaurant yang didirikan sejak tahun 2000 oleh 
                            Bapak Khairul Walidin dan Muhd. Almeer Farsha untuk menjalankan usaha kuliner
                            yang otentik di daerah Aceh. Mereka membawa dan menggabungkan konsep teknologi
                            dan kuliner dalam membentuk usaha mereka. Waktu terus berjalan dan restaurant kami
                ...
                <div class="order-1 w-full px-3 lg:w-1/2 lg:order-0">
                    <div class="w-full lg:max-w-md">
                        ...
                        <p class="mb-4 font-medium tracking-tight text-gray-400 xl:mb-6">Lorem ipsum dolor sit amet
                            Kami menyediakan konsep yang menarik, yaitu konsep teknologi dan konsep kuliner
                        yang digabung menjadi satu kesatuan. Kami juga memberikan pelayanan dan rasa terbaik
                    yang dapat kami berikan kepada pelanggan kami. Berikut adalah fitur-fitur unggulan
                dari restaurant kami.</p>
                        <ul>
        ...
        <div class="grid gap-2 lg:grid-cols-3">
            <div class="max-w-md p-4 bg-white rounded-lg shadow-lg">
                ...
                <div>
                    ...
                    <p class="mt-2 text-gray-600">Makanan ini sangat enak dan sangat keren. Konsep yang dibawakan unik dan otentik.</p>
                </div>
